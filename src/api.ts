...
export const makeApp = (dataSource: DataSource) => {
    ...
    const followHighService = new FollowHighService(followLowService, followReqService, userService);
    app.use("/user", makeUserRouter(userService, jwtService, followHighService));
    ...
    const homePageService = new HomePageService(postService, userService, followLowService);
    const likeRepo = new LikeRepository(dataSource);
    const likeService = new LikeService(likeRepo, postService, userService, followHighService);
